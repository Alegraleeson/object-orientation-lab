...
favoriteThings.car = 'Darwin';

favoriteThings[`show`] = 'Sailor Moon';
...
let twinkle = new Cat('Twinkle', 'b+w', 20)
...
let merlin = new Wizard('Merlin', 9000, 'death')
...
let iphone = new Phone('apple', 'x10', 32, 'white', 800 )
let android = new Phone('samsung', 'x50', 64, 'black', 600)
let blackberry = new Phone('microsoft', 'blackberry', 108, 'red', 1000)
...
let myFirstVehicle = new Vehicle(5,'orange',1600)
...
let myFirstMotorcycle = new Motorcycle(2,'black',600,'harley',true)
...
let myFirstBoat = new Boat(100, "white", 200, 'Big Bertha', 'yacht', false)
